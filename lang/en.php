...
return array (
  ...
  array (
    ...
    'unknownMsgLabel' => '💬 Unknown message reply',
    'resetAllLabel' => '🔁 Reset all to default',
    'resetAllDone' => '🔁 All texts, stickers, and reactions in this section (across all languages) were reset to the bot\'s defaults.',
    'home_text' => '📝 <b>Edit bot texts</b>

Pick the text you want to change.

🟢 A green button means this item has been customized:
✏️ text changed   ❤️ has a reaction   🖼 has a sticker
...
Current language: <b>{lang}</b>',
    ...
    array (
      ...
      14 => 
      array (
        'label' => '🛍️ After-purchase message',
...
✅ Minimum amount %s Toman, maximum amount %s Toman',
    ...
    The minimum amount for payment via this gateway is 5000 Toman.',
      'pendingPayment' => '❌ You have an unconfirmed payment, please wait until the previous payment is reviewed, then submit a new one',
      'cardEnabledNotice' => '💳 Dear user, the card number has been enabled for you. You can now complete your purchase.',
      'cardInstructionAlt' => 'To pay, deposit the amount to the card number below',
      'giftDepositAlt' => '🎁 Dear user, %s Toman has been deposited into your account as a gift.',
      'giftFromManagement' => '🎁 Dear user, %s Toman has been deposited into your wallet as a gift from the management.',
      'deductedNotice' => '❌ Dear user, %s Toman has been deducted from your wallet balance.',
      'addedNotice' => '💎 Dear user, %s Toman has been added to your wallet balance.',
      'deductedNotice2' => '❌ Dear user, %s Toman has been deducted from your wallet balance.',
      'addedNotice2' => '💎 Dear user, %s Toman has been added to your wallet balance.',
      'addedNotice3' => '💎 Dear user, %s Toman has been added to your wallet balance.',
      'addedNotice4' => '💰 Dear user, %s Toman has been added to your balance.',
      'addedNotice5' => '💰 Dear user, %s Toman has been added to your balance.',
      'confirmError' => '❌ An error occurred during confirmation, please go through the payment steps again',
      'depositRange' => '❌ The minimum deposit for this payment method is {mainbalance} and the maximum is {maxbalance} Toman',
      'depositRangePlisio' => '❌ The minimum deposit for this payment method is {mainbalance} and the maximum is {maxbalance} Toman',
      ...
      'receiptCooldown' => '❗ You sent a receipt within the last 2 minutes, please send the new receipt in 2 minutes.',
      'alreadyConfirmed' => '❗️ Your transaction has already been confirmed by the bot.',
      'transactionExpired' => '❗ This transaction has expired and can no longer be paid.',
      'askReceiptImage' => '🖼 Please send the image of your receipt',
      'askReceiptOrTron' => '📌 Please send your deposit image or the Tron transaction link.',
      'restartPurchaseOrPay' => '❌ An error occurred, please go through the purchase or payment steps again',
      'onlyOneImage' => '❌ You may only send one image',
      'receiptSentRenew' => '🚀 Your receipt has been sent and your service will be renewed after review',
      'receiptSentExtraVolume' => '🚀 Your receipt has been sent and extra volume will be added to your service after review.',
      'receiptSentExtraTime' => '🚀 Your receipt has been sent and extra time will be added to your service after review',
      'added' => '💎 Dear user, %s Toman has been added to your wallet balance.',
      'deducted' => '❌ Dear user, %s Toman has been deducted from your wallet balance.',
      'lessThanPrice' => 'The balance is lower than the product price',
      'cardInstruction' => 'To pay, deposit the amount to the card number below',
      'giftDeposit' => '🎁 Dear user, %s Toman has been deposited into your account as a gift.',
      'giftDepositIranpay' => '🎁 Dear user, %s Toman has been deposited into your account as a gift.',
      'giftDepositPlisio' => '🎁 Dear user, %s Toman has been deposited into your account as a gift.',
      'refundCreateFailed' => '💎 Dear user, because the service could not be created, %s Toman has been added to your wallet.',
      'refundRenewFailed' => '💎 Dear user, because the service could not be renewed, %s Toman has been added to your wallet.',
...
💬 The amount must be at least %s Toman and at most %s Toman',
      'chargedThanks' => '💲 Dear user, %s Toman has been credited to your wallet.
                
Thank you for your payment.🙏
                
🛒 Your tracking code: %s',
      'cryptoInstruction' => '
<b>💲 To top up your wallet with cryptocurrency, click the payment button at the end of this message</b>

⚠️ Note: the payment window is 30 minutes; after 30 minutes the transaction will be cancelled

🌐 Some local sites for buying cryptocurrency
...
📊 Dollar rate: currently %s Toman


<blockquote>⚠️ After payment, if the transaction amount was transferred correctly, your wallet will be topped up automatically within 5 minutes.</blockquote>
...
<blockquote>⚠️ After payment, if the transaction amount was transferred correctly, your wallet will be topped up automatically within 15 minutes.</blockquote>


Use the button below to pay 👇🏻',
      'debtRequired' => '❌ You have a debt, you must pay at least %s Toman.
         Please send your amount again',
      'enterAmount' => '💸 Enter the amount in Toman:

⚠️ Minimum <b>%s</b>, maximum <b>%s</b> Toman',
      'invoiceExpired' => '⭕️ Dear user, the invoice below expired because it was not paid within the specified time.
❗️Please do not pay anything for this invoice and create a new one.

🛒 Your payment method: %s
📌 Invoice code: <code>%s</code>
🪙 Invoice amount: %s Toman',
      'invoiceCreated' => '✅ The payment invoice has been created.

🔢 Invoice number: %s
💰 Invoice amount: %s Toman

❌ This transaction is valid for one hour; after that it can no longer be paid.        

📌 After a successful payment, please wait a moment until you receive the successful-payment message on our site. Otherwise your account will not be credited.
...
❌ This transaction is valid for one day; after that it can no longer be paid.        

📌 After a successful payment, please wait a moment until you receive the successful-payment message on our site. Otherwise your account will not be credited.

Use the button below to pay👇🏻',
      'queueBusy' => 'The payment gateway queue is extremely busy 📊

‼️Please use another payment method for now',
      'plisioExpired' => '❌ The transaction below expired because it was not paid. Please do not pay anything for this transaction

🛒 Order code: %s
💰 Amount: %s Toman',
      'transactionCreated' => '✅ Your transaction has been created
...
❌ This transaction is valid for 24 hours; after that it can no longer be paid.        


✅ If you have any problem you can contact support',
      'transactionCreated2' => '✅ Your transaction has been created
...
🔹 The transaction is valid for one day; after that a payment will not be confirmed.
❌ After the transaction it takes 15 minutes to one hour for it to be confirmed

✅ If you have any problem you can contact support',
      'transactionCreated3' => '✅ Your transaction has been created
...
✅ If you have any problem you can contact support',
      'transactionCreatedStar' => '✅ Your transaction has been created

🛒 Tracking code: <code>%s</code>
💲 Transaction amount: %s ⭐ (equal to %s Toman]

📌 Please convert %s Toman into Telegram Stars and send it.
...
📌 Send <code>%s</code> TRX (equal to %s Toman) to the wallet address above, then click the button below and send the receipt.

💢 Please note the following before paying 👇

🔸 If the wallet address is entered incorrectly, the transaction will not be confirmed and a refund is not possible
🔹 The amount sent must not be less or more than the announced amount
🔸 If you send more than the stated amount, the difference cannot be added
🔹 Each transaction is valid for one hour; after receiving the expiry message, never send any amount to the wallet!

📨 If you have any problem you can contact support',
      'selectPaymentGrouped' => '⬇️ Choose a payment method:',
      'pkgPromptTitle' => '#️⃣ <b>Top-up amount</b>

Pick an amount from the buttons, or choose <b>Custom amount</b>.

<b>Suggested amounts match the plans above this step.</b>

🕘 After paying, send the receipt on the next step.

• <b>Amount buttons:</b> pick one of the suggested amounts directly.
• <b>Custom amount:</b> enter your own amount.
• <b>Back to payment method:</b> go back to choosing a payment method.',
      'backToMethodBtn' => '🔙 Back to payment method',
      'customAmountBtn' => '✏️ Custom amount',
      'customAmountPromptTitle' => '#️⃣ <b>Custom amount</b>

Send a number in {currency} in the chat.

Example: 50000

Use the buttons below if you need to go back.

⬅️ Send the number only, no letters or extra characters.',
      'confirmContinueCaption' => '✅ Amount <b>%s</b> selected for <b>%s</b>.
...
📌 Your purchase includes a %s percent discount',
      ...
      'appliedRenew' => '🤩 Your discount code was valid and a {discount_price} percent discount was applied to your invoice.',
      'applied' => '🤩 Your discount code was valid and a {discount_price} percent discount was applied to your invoice.',
      'notAllowed' => '❌ Purchasing with this discount code is not possible',
    ),
    'Major' => 
    array (
...
⚠️ The minimum is 1 and the maximum is 15',
      ...
      'minBalance' => '❌ For a bulk purchase you must have at least {PaySetting} Toman in your balance.',
    ),
...
❌ The banner must include an image',
      ...
      'balanceGift' => '🎁 {addbalancediscount} has been added to your balance from a referral with user ID {from_id}.',
      'pointsEarned2Alt' => '📌 You earned 2 new points.',
      'pointsEarned1Alt' => '📌 You earned 1 new point.',
      'accountScore' => '🥅 Your account score: {score}',
      'notReferral' => '📛 You are not a referral of any user.',
      'joinedGift' => '🎉 Someone joined through your referral! The gift has been deposited into your account.',
      'joinGiftActivated' => '🎉 The membership gift has been activated for you!',
      ...
      'commissionPaid' => '🎁  Commission payment 
        ...
        %s Toman from your referral has been credited to your wallet',
...
By inviting friends through your <b>personal link</b>, your wallet gets topped up without paying anything, and you can use the bot services!
...
<b>📢 Invite, get gifts, grow!</b>
',
      'welcomeInvited' => '<b>🎉 Welcome!</b>

You joined the bot through <b>@%s</b> and were registered as their referral ✅

To receive the membership gift:
🔘 Go to the <b>Referrals</b> menu  
🔘 Press the <b>🎁 Claim membership gift</b> button

This way both you and your inviter get a gift! 💰
',
      'membershipGiftClaimed' => '<b>⛔ You have already claimed the membership gift.</b>
This gift can only be activated <b>once</b>.',
      'membershipGiftInfo' => '<b>🎁 Membership gift:</b>
• 🎉 Total gift: %s Toman  
• 🔻 50%% for you (the inviter)  
• 🔻 50%% for the referral (the new user]
',
      'purchaseCommissionInfo' => '<b>💸 Purchase commission:</b>  
•  %s percent of your referral\'s purchase amount goes to you',
      'referralLink' => '

🔗 Referral link for registering referrals:
...
💸 Cost of obtaining an agency: %s Toman',
      ...
      'welcome' => '👋 Welcome to the agency panel',
      'usernameSaved' => '✅ Your username has been saved successfully.',
      'requestRejected' => '❌ Dear user, your agency request has been rejected.',
      'requestApproved' => '✅ Dear user, your agency request has been approved and you are now an agent.',
      'expiredNotice' => '📌 Dear agent, your agency period has ended and your account is no longer an agency account. To reactivate the agency you can contact support.',
    ),
    'app' => 
    array (
...
You can now use the bot ✔️',
    ...
    array (
      ...
      'serviceInactive' => '❌ The service is inactive and the link cannot be changed.',
      'error' => '❌ An error occurred while changing the link.',
      'updated' => '✅ Your config has been updated successfully.',
    ),
    'channel' => 
    array (
    ...
    array (
      ...
      'invalidTimeRange' => '❌ The submitted duration is invalid. It must be between {maintime} and {maxtime} days',
      'invalidVolume' => '❌ The volume is invalid.
🔔 The minimum volume is {mainvolume} GB and the maximum is {maxvolume} GB',
    ),
...
⬅️ To return to your service list or view the details, click the buttons below.',
      'title' => '💊 Renew service',
      'error' => '❌ The renewal failed, please go through the renewal steps again.',
      'notSupportedPanel' => '❌ Renewal is not possible on this panel',
      'connectFirst' => '❌ You have not connected to the service yet. To renew, connect to the service first and then proceed with the renewal',
      'planNotAvailable' => '❌ Renewal with the current plan is not possible. Please start over and choose another plan.',
      'restartError' => '❌ An error occurred, please start the renewal steps from the beginning.',
      'errorSupport' => '❌ An error occurred while renewing the service, please contact support',
      'errorSupport2' => '❌ An error occurred while renewing the service, please contact support',
      'genericError' => '❌ An error occurred during renewal, please contact support',
      'genericErrorApi' => '❌ An error occurred while renewing the service, please contact support',
      'invoiceCreatedByAdmin' => '📜 Your renewal invoice for username %s has been created.
...
📌 As a renewal gift, %s Toman has been credited to your account',
      'giftChargedFn' => 'Congratulations 🎉
📌 As a renewal gift, %s Toman has been credited to your account',
      'invoiceCreated' => '📜 Your renewal invoice for username %s has been created.
...
💸 Wallet balance: %s
✅ Click the button below to confirm and renew the service',
      'invoiceCreated2' => '📜 Your renewal invoice for username %s has been created.
...
',
    ...
    array (
      ...
      'notSupportedPanel' => '❌ Buying extra time is not possible on this panel',
      'invoiceCreated' => '📜 An invoice for buying extra time has been created for you.
        
📌 Rate per extra day: %s Toman
📆 Requested extra days: %s days
💰 Your invoice amount: %s Toman
        
✅ To pay and add the time, click the button below',
      'prompt' => '📆 Enter the number of extra days you want (in days):
...
▫️Amount for the extra time: %s Toman',
...
n2 = agent with more capabilities',
      ...
      'notSupportedPanel' => '❌ Buying extra volume is not possible on this panel',
      'serviceError' => '❌ An error occurred while buying extra volume, please contact support',
      'invoiceCreated' => '📜 An invoice for buying extra volume has been created for you.
        
📌 Rate per extra gigabyte: %s Toman
🔋 Requested extra volume: %s GB
💰 Your invoice amount: %s Toman
        
✅ To pay and add the volume, click the button below',
      'prompt' => ' ⭕️ Send the amount of volume you want to buy.
❌ Please send the number in English digits.
        ⚠️ Each extra GB costs %s Toman.',
      'success' => '✅ Volume was added to your service successfully
 
▫️Service name: %s
▫️Extra volume: %s GB

▫️Amount for the extra volume: %s Toman',
...
🔄 Please send your username again',
    ...
    array (
      ...
      'fetchError' => '❌ Fetching the price is not possible right now. Please try again later.',
    ),
    'search' => 
    array (
      'title' => '🔎 Quick search',
...
⭕️ You can also use the "🔎 Quick search" button to quickly find and manage your service',
      ...
      'panelCapacityFull' => '❌ Unfortunately the account creation capacity on this panel is full, please use another panel',
      'capacityFull' => '❌ Unfortunately the account creation capacity is full, please try again in a few hours.',
      'nullPanel' => '⭕️ No location was found, please contact support to resolve the issue',
      'selectDuration' => '📌 Please select the service duration',
      'purchaseError' => '❌ The purchase failed, please go through the steps again.',
      'stockFinished' => '❌ This service is out of stock.',
      'stockFinishedBuyAnother' => '❌ This service is out of stock, please purchase another service.',
      'selectCategoryShort' => '📌 Please select a category',
      'selectCategory' => '📌 Please select your category!',
      'panelUnavailable' => '❌ This panel is unavailable, please purchase from another panel.',
      'restartProcess' => '❌ Please go through the purchase steps again',
      'creating' => '♻️ Creating your service...',
      'restartFromStart' => '❌ Please start the purchase steps from the beginning',
      'noPurchaseUsersOnly' => '❌ Unfortunately this option is only available to users who have not made a purchase from the bot.',
      'invalidTimeRestart' => 'The duration is invalid, please start the purchase from the beginning',
      'invalidVolumeRestart' => 'The volume is invalid, please start the purchase from the beginning',
      'panelInactive' => 'The selected panel is not active at the moment',
      'panelMissing' => 'The selected panel does not exist.',
      'productNotFound' => 'The selected product was not found',
      'subscriptionError' => 'An error occurred while creating the subscription, please contact support',
      'usernameExists' => 'The username already exists, please start the steps from the beginning',
      'customTimePrompt' => '⌛️ Select the duration of your service 
📌 Rate per day: %s  Toman
⚠️ You can choose a minimum of %s days and a maximum of %s days',
      'customTimePrompt2' => '⌛️ Select the duration of your service 
📌 Rate per day: %s  Toman
⚠️ You can choose a minimum of %s days and a maximum of %s days',
      'customVolumePrompt' => '📌 Send the volume you want.
🔔 The price per GB is %s Toman.
🔔 The minimum volume is %s GB and the maximum is %s GB.',
      'customVolumePrompt2' => '📌 Send the volume you want.
🔔 The price per GB is %s Toman.
🔔 The minimum volume is %s GB and the maximum is %s GB.',
      'customVolumePrompt3' => '📌 Send the volume you want.
🔔 The price per GB is %s Toman.
🔔 The minimum volume is %s GB and the maximum is %s GB.',
      'customVolumePrompt4' => '📌 Send the volume you want.
🔔 The price per GB is %s Toman.
🔔 The minimum volume is %s GB and the maximum is %s GB.',
      'customVolumePrompt5' => '📌 Send the volume you want.
🔔 The price per GB is %s Toman.
🔔 The minimum volume is %s GB and the maximum is %s GB.',
      'preInvoice' => '🌐 Confirm purchase

⬅️ Alright, are you sure you want this service?

✏️ Service name: %2$s
📤 Service volume: %6$s GB
📅 Validity period: %3$s days

🏷 Original price: <del>%4$s</del>
🏷 Discounted price: %5$s

✅ Once confirmed, the service will be purchased.',
      'preInvoice2' => '🌐 Confirm purchase
...
✅ Once confirmed, the service will be purchased.',
      'created' => '✅ The service was created successfully
...
🧑‍🦯 You can get the connection method by pressing the button below and selecting your operating system',
      'created2' => '✅ The service was created successfully
...
🧑‍🦯 You can get the connection method by pressing the button below and selecting your operating system',
      'timePrompt' => '⌛️ Select the duration of your service 
📌 Rate per day: %s  Toman
⚠️ You can choose a minimum of %s days and a maximum of %s days',
      'volumePrompt' => '🔋 Please enter the amount of service volume you want (in gigabytes):
📌 Rate per GB: %s 
🔔 The minimum volume is 1 GB and the maximum is 1000 GB.',
      'noPaymentMethod' => '😕 No payment method is available for you right now.

Please contact support and they\'ll help you out.',
      'selectUsernamePrompt' => 'Would you like to choose the service name yourself, or use a default one?

If you have a name in mind, just type it in this chat (English letters and digits only).

To use a default name, tap the green button; to cancel and go back to the plan list, tap the red button.',
    ),
    'spam' => 
    array (
...
🔄 Please send your username again',
      ...
      'username' => 'Username: ',
      'btnConfirmDisable' => '✅ Confirm and disable the config',
      'btnConfirmEnable' => '✅ Confirm and enable the config',
      'deleteRequestApproved' => '✅ Dear user, your deletion request for username %s has been approved.',
      'deleteRequestApproved2' => '✅ Dear user, your deletion request for username %s has been approved.',
      'servicesFound' => '🛍 {countservice} services found. Click one of the services to view and manage it',
      'infoUnavailable' => '❌ Viewing the account information is not possible right now',
      ...
      'btnTurnOff' => '❌ Turn the account off',
      'btnTurnOn' => '💡 Turn the account on',
      'btnEditNote' => '📝 Edit note',
      'btnRefresh' => '♻️ Refresh information',
      'deletedSuccess' => '📌 The service was deleted successfully',
      'askDeleteReason' => '📌 Please send the reason for deleting your service.',
      'configReadError' => '❌ Error reading the config information, please contact support.',
      'selectConfig' => '📌 Please select a config from the list below.',
      'btnConfirmDisableAlt' => '✅ Confirm and disable the config',
      'btnConfirmEnableAlt' => '✅ Confirm and enable the config',
      'subscriptionLine' => 'Your subscription: <code>{output_config_link}</code>',
      'getConfigHint' => '📌 To receive the config, click the Get config button',
      'notConnectedCannotChange' => '❌ The config has not been connected to yet, so the service status cannot be changed. After connecting to the config you can use this feature.',
      'confirmDisableDesc' => '📌 By confirming the option below, your config will be turned off and connecting to it will no longer be possible.
⚠️ If you want to enable the config again, you must click the <u>💡 Turn the account on</u> button in the service management section',
      'confirmEnableDesc' => '📌 By confirming the option below, your config will be turned on and you will be able to connect to it
⚠️ If you want to disable the config again, you must click the <u>❌ Turn the account off</u> button in the service management section',
      'deleteRequestRejected' => '❌ Dear user, your deletion request for username %s was not approved.
        
        Reason for rejection: %s',
      'notConnectedCannotChangeStatus' => '❌ You have not connected to the config yet, so the service status cannot be changed. After connecting to the config you can use this feature.',
      'confirmDisableConfig' => '📌 By confirming the option below, your config will be turned off and connecting to it will no longer be possible.
⚠️ If you want to enable the config again, you must click the <u>💡 Turn the account on</u> button in the service management section',
...
🔄 Last subscription link update: %s
...
💡 To cut off other people\'s access, just click the "Change link" option.',
      'summary' => '
...
#️⃣ Connected client: <code>%s</code>',
    ...
    array (
      ...
      'requestSubmitted' => '✅ Thank you for submitting your request. It has been sent and is being reviewed by support.',
      'selectDepartment' => '📌 Please select the support department you want to message.',
      'sendMessage' => '📌 Please send your message',
      'sentForReview' => '✅ Your message was sent successfully and will be answered after review.',
      'sendMessageText' => '📌 Please send the text of your message',
      'sentSuccess' => 'The message was sent successfully',
      'sentForRequestReview' => '✅ Your message for this request was sent successfully and will be answered after review.',
      'messageFromAdminAlt' => '
...
📩 A message has been sent to you from the management.
...
Message text: 
%s',
      'disruptionConfirm' => '❓ Are you sure you want to send an outage report

🔹 Before sending a report, please review the connection tutorials. ( /help )',
      'disruptionPrompt' => '❓ Please describe the cause of your outage
...
🔹 Before sending a report, please review the connection tutorials. ( /help )',
    ...
    array (
      ...
      'unavailable' => '📌 The test service is currently unavailable.',
    ),
    'wheelLuck' => 
    array (
    ...
    'featureUnavailable2' => '❌ This feature is currently unavailable.',
    'genericRestart' => '❌ An error occurred, please go through the steps again',
    'genericRestart2' => '❌ An error occurred, please start the steps from the beginning',
    'infoFetchErrorRestart' => '❌ An error occurred while fetching the information, please start the steps from the beginning',
    'sectionDisabled' => '📛 This section is currently disabled',
    'account' => 
    array (
      'verifiedByAdmin' => '💎 Dear user, your account has been successfully verified by the admin and you can now complete your purchase',
      'verifiedNotice' => '💎 Dear user, your account has been successfully verified and you can now complete your purchase',
...
📆 %s → ⏰ %s
    ...
    For a faster follow-up you can message the ID below
    @%s',
      'infoSimple' => '👤 <b>Account</b>
...
✔️ Use the button below to top up.',
    ...
    array (
      ...
      'configUnused' => '❌ Your config is in an unused state and the service location cannot be transferred.',
      'confirmPrompt' => '📍 By confirming the transfer, your service in this location will be deleted and moved to the new location.
💰 The transfer fee is %s Toman
📌 Your remaining limit: %s (remaining free transfers: %s]

✅ Click the button below to confirm the transfer',
      'success' => '✅ Your config was successfully transferred to server (%s).
...
<code>%s</code>',
    ...
    'notify' => 
    array (
      'remainingDays' => 'Remaining days: %s',
      'remainingVolume' => 'Remaining volume: %s',
      'thanks' => 'Thank you for staying with us',
      'timeActionHint' => 'If you wish to renew this service, please proceed via the «%s» section. ',
      'timeRemaining' => '📌 Only %s days remain of the validity period of service %s. ',
      'volumeActionHint' => 'If you wish to buy extra volume or renew your service, please proceed via the «%s» section',
      'volumeRemaining' => '🚨 Only %s remains of the volume of service %s. ',
...
',
      'serviceDeleted' => '📌 Dear user, because it was not renewed, service %s has been removed from your service list

🌟 To get a new service, please use the purchase section',
      'serviceDeleted2' => '📌 Dear user, because it was not renewed, service %s has been removed from your service list
...
Remaining days: %s 
 Remaining volume: %s
User last connection: %s',
      'onHoldReminder' => 'Hello! 🌐

We noticed that you have not yet connected to your config with username %s, and more than %s days have passed since it was activated. If you have any trouble setting up or using the service, please contact our support team via the ID below so we can help you.
We are ready to solve any question or problem! 📞

Support account: @%s',
    ),
    'transfer' => 
    array (
      'confirm' => '✅ If you confirm, click the button below to complete the transfer.',
      'confirmed' => '✅ The service was transferred successfully.',
      'notSendServiceYou' => '❌ You cannot transfer a service to yourself.',
      'notUserTrans' => '❌ No user was found with this ID.',
      'title' => '🚚 Transfer the service to another user',
      'transferNotValid' => '❌ A test service cannot be transferred to another user.',
      'description' => '🛂 To transfer this subscription to another user, you need the user ID of the destination account.

‼️ Transfer notes:
1 - To get the user ID, go to the wallet button  
2 - After the subscription is transferred to the destination user, it will be removed from your panel.

🆕 Enter the user ID of the destination account:',
      'receivedNotice' => '✅ Dear user, the service with username {service_username} has been transferred to your account from the user with ID {from_id}.',
    ),
    'lottery' => 
    array (
      'winnerNotice' => '🎁 Lottery result 

😎 Dear user, congratulations! You are winner number %s of %s Toman and your account has been credited.',
    ),
  ),
  'Admin' => 
  array (
...
Description: To deduct the user\'s balance, first send the user\'s numeric ID',
      ...
      'addedToUserNotice' => '❌ %s Toman was added to the user\'s balance.',
      'askChargeAmount' => '📌 Send the amount you want to add to the user\'s account.',
      'askMaxCharge' => '📌 Set the maximum amount a user can charge to their account',
...
Note: the number must be without a dash or minus sign
If you want the user to be able to purchase without limit, send 0',
      'askMinCharge' => '📌 Set the minimum amount a user can charge to their account',
      'askMinChargeGroup' => '📌 Which user group is this minimum balance for?
f
n
n2',
      'askMinDeposit' => '📌 Send the minimum deposit amount',
      'askNotify' => '📌 Should a charge notification message be sent to users? 
Yes: 1 
No: 0',
      'askTargetUsers' => '📌 Which users should receive the group charge',
      'askUserGroup' => '📌 Which of the following user groups should receive the charge.',
      ...
      'maxDepositSaved' => '✅ Maximum deposit amount has been set.',
      'minDepositSaved' => '✅ Minimum deposit amount has been set.',
      'operationStarted' => '✅ The message sending operation has started, you will be notified when it finishes.',
      'resetToZero' => 'The user\'s balance was reset to zero from %s',
    ),
    'Channel' => 
    array (
...
2 - Add the bot @myidbot to the group and send the /getgroupid@myidbot command inside the group
3 - Turn on Topics/Forum mode for the group from the group settings
4 - Make your own bot an admin of the group
5 - Send the received numeric ID to the bot.

Your current numeric ID: %s',
      'botNotGroupAdmin' => '❌ The bot is not an admin of the group',
      'connectionFailed' => '❌ Connection to the group was not successful  

Error received:  %s',
      'notForumGroup' => '❌ The selected group is not in forum mode. First enable the group\'s Topics feature, then set the group\'s numeric ID again',
    ),
    'Discount' => 
    array (
...
⚠️ The limit is for all users',
      'askActiveHours' => '📌 For how many hours should the discount code be active. If you want it unlimited, send 0',
      'askProduct' => '📌 Which product should the discount code apply to. Note: if you want the discount code to apply to all products, send the word all',
      'askProductLocation' => '📌 To set a discount code for a specific product, first select the product\'s location.
...
🔴 Usage limit: %s',
      ...
      'userLimitTooHigh' => '📌 The usage count per user must be less than the total limit',
    ),
    'Discountsell' => 
    array (
...
2 - You can send the tutorial as a video, text, or image',
      'categoryUpdated' => '✅ The tutorial category name was updated',
      'descUpdated' => '✅ The tutorial description was updated',
      'invalidContent' => '❌ The sent content is invalid.',
      'nameExists' => '❌ This tutorial name already exists, use a different name.',
      'nameTooLong' => '❌ The tutorial name must be less than 150 characters',
      'nameUpdated' => '✅ The tutorial name was updated',
      'tutorialSaved' => '✅ The tutorial was saved successfully.',
      'listCaption' => '📚 <b>Manage tutorials</b>

Pick the tutorial you want to manage.

🌐 Current language: <b>{lang}</b>',
      'editContentBtn' => '📝 Content & media',
      'resetLangBtn' => '🔁 Reset this language',
      'backToListBtn' => '🔙 Back to list',
      'askTranslatedName' => '📌 Send this tutorial\'s name for this language',
      'askTranslatedContent' => '📌 Now send this tutorial\'s content for this language (text, or a photo/video/file with a caption)',
      'translationSaved' => '✅ This language\'s translation was saved',
      'resetDone' => '✅ This language was reset to the default (Persian)',
      'itemStatusTranslated' => '✅ Translated for this language',
      'itemStatusDefault' => '⚪ Not translated — Persian is shown',
      'itemStatusBase' => '🟣 Base (original) language',
      'emptyList' => '📚 No tutorials have been added yet',
      'editNameBtn' => '✏️ Tutorial name',
      'editCategoryBtn' => '🗂 Category',
      'askOnlyName' => '✏️ Send the new tutorial name for this language:',
      'askOnlyCategory' => '🗂 Send the category name for this language:',
      'askOnlyContent' => '📝 Send the tutorial content:

You can send plain text, or a photo/video/file with a caption.
✨ Premium emoji and formatting are preserved.',
      ...
      'mediaDocument' => '📎 File',
      'mediaNone' => '— none',
      'homeCaption' => '📚 <b>Manage tutorials</b>

What would you like to do?

Current language: <b>{lang}</b>',
      'viewListBtn' => '📋 Tutorial list',
      'previewBtn' => '👁 Preview (user view)',
      'backToHomeBtn' => '🔙 Back to tutorial management',
      'previewCaption' => '👁 <b>Preview</b>

This is exactly what a user with language <b>{lang}</b> sees.
Tap a tutorial to see its content too.',
      'previewNote' => '👁 Preview — this is what the user sees:',
      'emptyListAlert' => '📚 You haven\'t added any tutorials yet!

First use the "Add tutorial" button to create one.',
      'emptyLangAlert' => '📚 No tutorial has been translated for this language yet!

Go to the 🇮🇷 Persian tab, open the list, tap the tutorial you want, and use "📝 Content & media" to add a translation for it.',
      'flowBusyAlert' => '⏳ You\'re in the middle of adding or editing a tutorial and need to finish that first!

Send what was requested to complete it.',
      'displayBtn' => '🎨 Categories & tutorials display',
      'displayCaption' => '🎨 <b>Categories & tutorials display</b>

What would you like to set up?

Current language: <b>{lang}</b>',
      'categoriesBtn' => '🗂 Categories',
      'tutorialsBtn' => '📚 Tutorials',
      'catSubCaption' => '🗂 <b>Categories</b>

Current language: <b>{lang}</b>',
      'tutSubCaption' => '📚 <b>Tutorials</b>

Current language: <b>{lang}</b>',
      'layoutBtn' => '📐 Layout',
      'emojiBtn' => '🎭 Emoji',
      'layoutCaption' => '📐 <b>Layout</b>

Tap one to select it, then tap another to swap their positions.
You can also toggle 🔲 full-width / side-by-side.',
      'emojiCaption' => '🎭 <b>Emoji</b>

Tap any item to set its emoji.',
      'layoutEmpty' => 'Nothing here yet',
      'toggleWidthBtn' => '🔲 Full-width / side-by-side',
      'resetLayoutBtn' => '🔄 Reset layout',
      'resetEmojiBtn' => '🔄 Reset all emoji',
      'askEmojiForItem' => '🎭 Send the emoji for "%s"

🔹 Regular emoji or 💎 premium emoji both work
(To remove the emoji, send 0)',
      'emojiSaved' => '✅ Emoji saved',
      'layoutSwapDone' => '✅ Swapped!',
      'colorBtn' => '🎨 Colors',
      'colorCaption' => '🎨 <b>Colors</b>

Tap any item to cycle its color 👇
⚪ Default ← 🔵 Blue ← 🟢 Green ← 🔴 Red',
      'simpleModeBtn' => '🔲 Simple mode: {state}',
    ),
    'Payment' => 
    array (
      ...
      'allReceiptsDeleted' => '✅  All receipts were successfully deleted ',
      'approvedByOther' => '✅. Payment already approved by another admin
👤 User ID: <code>%s</code>
🛒 Payment tracking code: %s
⚜️ Username: @%s
...
💸 Amount paid: %s Toman
',
      'askAutoConfirmMinutes' => '📌 In this section you can set after how many minutes the auto-confirm-without-review feature approves a receipt.
...
Current time: %s',
      ...
      'autoConfirmDesc' => '📌 By enabling this feature, when you\'re not online, the bot automatically confirms all card-to-card transactions. Then, once you\'re online, you review the receipts, and if a fake receipt was sent, you cancel that transaction',
      'autoConfirmSelect' => '📌 Select an option
⚠️ This section is for auto-confirm without review',
...
⭕️ Payment method : %s 
📆 Purchase date :  %s',
      'disableAutoConfirmFirst' => '❌ First turn off auto-confirm without review.',
      'disableAutoConfirmFirst2' => '❌ First turn off auto-confirm.',
      'excludeListEmpty' => '❌ No user exists in the list',
      'excludeListTitle' => 'List of people👇',
      'noPending' => '❌ You have no unconfirmed payments.',
      'pendingIntro' => '📌 Unconfirmed card-to-card payments 
In this section you can view unconfirmed payments and approve or reject them.
❌ : Reject payment 
✅ : Approve payment
📝 Payment details
🗑 : Delete receipt without notifying the user',
      'receiptDeleted' => '✅ The receipt was successfully deleted.',
      'reviewReceiptsFirst' => '⚠️ To approve user requests, first review and approve purchase or subscription renewal receipts. Then approve the wallet charge receipt. ',
...
User types: f, n, n2',
      ...
      'askNote' => ' 🗒 Send a note for the product. This note will be shown on the user\'s invoice.',
      'askNote2' => ' 🗒 Send a note for the product. This note will be shown on the user\'s invoice.',
      'askVolumeResetType' => 'Send the volume reset type',
      'cannotChangeToAll' => '❌ You cannot change the defined product to the /all location name.',
      'categoryUpdated' => '✅ The product category was updated',
      'editSummary' => '
📌 Product information being edited:
Product name :  %s
Product price : %s
Product volume : %s
Product location : %s
Product time : %s
Product user type : %s
Product volume periodic reset : %s
Product note : %s
Product category : %s
Number of product sold : %s pcs
    ',
      'firstPurchaseDesc' => '📌 With this feature you can set whether this product is for first purchase only or not',
      'invalidUserGroup' => '❌ Invalid user group',
      'locationUpdated' => '✅ The product location was updated',
      'nameExists' => '❌ A product with the name %s already exists',
      'nameExists2' => '❌ A product with the name %s already exists',
      ...
      'selectNewLocation' => '📌 Select the product\'s new location',
      'updated' => '✅ The product was updated',
      'premiumEmojiHint' => '

💡 To add an emoji (even premium) next to the product name, use "🎨 Shop Display & Appearance" from the main menu — this is just the plain name.',
    ),
    'Protocol' => 
    array (
    ...
    array (
      ...
      'statuson' => '✅ On',
      'subject' => 'Title',
      'applyScope' => 'Should this be disabled for all users or only new users?
    New users 0 
    All users 1
    2 All users except agents',
      'botOff' => '❌ The bot is off',
      'botOn' => '✅  The bot is on',
      'iranPhoneOff' => '❌ Iranian phone number check is disabled',
      'iranPhoneOn' => '✅ Iranian phone number verification is on',
      'off' => 'Off',
      'on' => 'On',
      ...
      'rulesOn' => '✅ Rules confirmation is on',
      'panelFeatureCaption' => '⚙️ <b>Panel Feature Status</b>
🖥 %s

Tap any button to switch it between ✅ on and ❌ off.

♻️ <b>Custom service</b> = allow buying a service with a custom volume, per user tier:
• <b>f</b> — regular user
• <b>n</b> — reseller
• <b>n2</b> — reseller level 2',
    ),
...
This step is mandatory',
    ...
    array (
      ...
      'askConfigCount' => '📌 Send the number of configs you want created, you can send up to 10',
      'askTime' => '📌 Send the service duration, the time is based on days.',
      'askVolume' => '📌 Send the account\'s usage volume. The volume is in gigabytes.',
...
⚠️ If you want the config to be added to the user\'s account so the user can manage it, you must use the Add Order option.
- To add a config, first send the username.',
      'panelSelected' => '✅ The panel was successfully selected',
      'selectPanel' => '📌 From the list below, select which panel the order should be created from',
      'usernameExists' => '❌ This username already exists in the bot.',
    ),
    'affiliates' => 
    array (
      'titleTopic' => '🎁 Commission reports',
      'askBanner' => '⭕️ Send your affiliate referral banner 

❌ The banner must be sent together with an image',
      'askJoinGift' => '📌 Enter the amount you want the user to receive for each new referral',
      'askPercent' => '📌 Send the percentage you want credited to the user after a purchase',
      'bannerSaved' => '✅ Your banner was successfully saved.',
      'commissionScope' => 'You can set whether the commission is given to the user only for their referral\'s first purchase, or for all of their purchases.',
      'idsSent' => '📌 The IDs of the user\'s referrals were sent.',
      'invalidBanner' => '❌ The sent banner is invalid (the banner must be sent with an image)',
      'joinGiftSaved' => '✅ The referral gift amount was successfully saved',
      'noReferrals' => '❌ The user has no referrals.',
      'percentSaved' => '✅ The deposit percentage to the user was successfully set',
      'referralsDeleted' => '📌 The user\'s referrals were deleted.',
      'userRemoved' => '📌 The user was removed from the referral list.',
    ),
    'agent' => 
    array (
...
Type three n2: a type-three agent with more capabilities',
      ...
      'askExpiry' => '🕘 Send the agency expiration time. After the set number of days ends, the user will exit agent status and become group f.
Note that this feature is not related to the bot-builder or agent sales-bot feature and only applies to your main bot

📌 Send the number of days',
      'askMembershipFee' => '📌 Send the membership request price for the agency.',
      'changeTypeHint' => '
Use the buttons below to change the agent type.',
      'expiryDateLabel' => '⭕️ Agency end date : ',
      'expirySaved' => '✅ The expiration date was set.
📌 After the time ends, the user\'s group will be changed to f and the user will be notified.',
...
Status: Approved (%s)',
    ...
    array (
      ...
      'askFallbackName' => '📌 If the user has no username, what name should be registered?',
      'selectMethod' => '⭕️ Select the account username generation method from the button below.
        
⚠️ If a user has no username, the word you chose will be registered and used in place of the username.
...
⚠️ If a username exists, a random number will be added to the username',
    ...
    array (
      'confirm' => '✅ Confirm transfer',
      'title' => '🌐 Change location',
      'askFreeLimit' => '📌  Send the free limit for how many times a user can change location. Note this limit applies to all configs
Current limit : %s',
      'askLimitType' => '📌 Select an option.
1 - The user\'s total limit for how many times they can change location overall.
2 - The user\'s free limit, i.e. how many of the total limit changes can be done for free.',
      'askTotalLimit' => '📌  Send the total limit for how many times a user can change location. Note this limit applies to all configs
Current limit : %s',
      'askUserLimit' => '📌 Send the new limit you want to set for the user. Note that this changes the count of location changes already made',
      'limitSaved' => '✅ The limit was successfully set.',
      ...
      'userLimitSaved' => '✅ The user\'s usage count was successfully saved.',
    ),
    'channel' => 
    array (
...
- To disable this feature, you must delete all channels',
      ...
      'askJoinLink' => '📌 Send the join link',
      'invalidJoinLink' => 'The join address is not valid',
      'joinChannelSaved' => '✅ The mandatory join channel was successfully saved.',
...
Current time: ',
      ...
      'askOnHoldDays' => 'In this section you must set after how many days, if the user hasn\'t connected to their config and is in on_hold status, a message is sent to the user',
      'askVolumeAlert' => '📌 In this section you can set that if the user\'s volume reaches x, a warning message is sent. Send the volume in gigabytes.',
      'btnSettings' => '🕚 Cron job settings',
      'cannotDeleteUnlimited' => '❌ Because the volume and time are unlimited, the service cannot be deleted. ',
      'timeSaved' => '✅ The time was successfully saved.',
...
<code>%s</code>',
    ...
    array (
      ...
      'askTime' => '🕰 Send the test service duration.
⚠️ The time is in hours.',
      'askVolume' => 'Send the test service volume.
...
Numeric ID: %s',
      ...
      'accountToggleBusy' => '❌ The bot is currently turning the account on or off. Wait for the previous operation to finish, then send a new request',
      'alreadyVerified' => '✍️ The user is already verified',
      'askTransferTargetId' => 'Send the numeric ID of the user you want all information transferred to
    Note that if the destination user has a balance, it will be deleted',
      'btnDisableAccount' => '❌ Turn off account',
      'configsQueuedDisable' => '✅  The user\'s configs were queued for disabling. Note this may take more than 2 hours; the time depends on the number of configs.',
      'configsQueuedEnable' => '✅  The user\'s configs were queued for enabling. Note this may take more than 2 hours; the time depends on the number of configs.',
...
⭕️ User status : %s
⭕️ Username : @%s
⭕️ Numeric ID :  <a href = "tg://user?id=%s">%s</a>
⭕️ Referral code : %s
⭕️ Join date : %s
⭕️ Last time user used the bot : %s
⭕️ Test account limit :  %s 
⭕️ Rules confirmation status : %s
⭕️ Mobile number : <code>%s</code>
⭕️ User type : %s
⭕️ Number of user\'s referrals : %s
⭕  Referrer : %s
⭕  Verification status: %s   
⭕  Show card number :‌%s
⭕ User score : %s
⭕️  Total active purchased volume (cron must be on for accurate volume stats): %s
%s
...
🔰️ Total amount paid  :  %s
🔰 Total purchases : %s
🔰 User discount percent : %s
🔰 Sales count last hour : %s pcs
🔰 Total sales last hour : %s Toman
🔰 Sales count last month : %s pcs
🔰 Total sales last month : %s Toman

',
      'notFound' => '❌ The user does not exist.',
      'notFoundById' => '📌 No user with numeric ID %s exists in the database',
      'notVerified' => 'Not verified',
      'transferDone' => 'The information was successfully transferred to the new account',
      'transferSameUser' => '❌ You cannot transfer information to the current user',
      'unknownName' => 'Unknown',
      'unverifiedSuccess' => '✅ The user was successfully unverified.',
      'verified' => 'Verified',
      'verifiedSuccess' => '✅ The user was successfully verified.',
    ),
    'manageadmin' => 
    array (
...
The support access level has access to user services and support message reply sections',
      ...
      'askMessageAdminId' => '📌 Send the numeric ID of the admin you want messages sent to',
      'cannotDeleteMain' => '❌ The main admin cannot be deleted',
      'deleted' => '✅ The admin was successfully deleted',
      'listAndDelete' => '📌 In the section below you can view the list of admins; you can also delete an admin by pressing the ❌ button',
...
If you want it to be unlimited, send the text unlimited',
      ...
      'alreadyAdded' => '❌ The panel is already added',
      'askAdminUuid' => '📌 Send the admin UUID',
      'askConfigUsername' => '📌 If your panel is Marzban or Marzneshin, copy a config username from the panel and send it; otherwise, for Sanaei and Alireza panels, send the inbound ID',
      'askGroupName' => '📌 Send the group name you want to be used as default.',
      'askHidePanelProduct' => '📌 If you have selected /all for the panel location but need to hide one panel, you can use this feature

To hide a panel, select your panels from the list below, then send the /end_hide command.',
      'askHidePanelsAgent' => '❌ Select the panels you want hidden from this agent using the button below. After selecting, send the /finish command to save.',
      'askHideUserId' => '📌 Send the numeric ID of the user for this panel.',
      'askInboundId' => '📌 Send the inbound ID you want configs created from. The inbound ID is a multi-digit number shown in the id column on the panel\'s inbounds page

⚠️ If your panel is wgdashboard, you must send the config name',
      'askProtocolSetup' => '📌 To set the inbound and protocol, create a config in your panel, activate the protocols and inbounds you want enabled inside the panel, then send the config\'s username',
      'askQrBackground' => 'Send your image for the background',
      'askServiceSetup' => '📌 To set up the service, create a config in your panel, activate the services you want enabled inside the panel, then send the config\'s username',
      'askShowPanelsAgent' => '❌ From the list below, select the panels you want shown again in the agent\'s bot. After selecting all panels, send the /remove command to save.',
      'askSubLinkSample' => '📌 If your panel is Sanaei, copy a user\'s sub link from the panel and send it in this section. For other panels, send it according to their own structure.',
...
❌ If you want the panel to be shown for all user groups, send the text all',
      ...
      'btnSubLinkDomain' => '🔗 Sub link domain',
      'errorCode' => '❌  An error occurred, error code:  %s',
      'eylanErrorCode' => '❌  An error occurred, error code:  %s',
      'eylanPanelOutput' => 'Panel output :',
      'eylanUserNotExist' => '❌ The user does not exist in the panel.',
      'fetchError' => '❌ An error occurred while fetching information  Error: ',
      'fetchErrorCode' => '❌ An error occurred while fetching information, error code: ',
      'groupNameSaved' => '✅ The group name was successfully set.',
      'hidden' => 'Hidden',
      'hiddenForUser' => '✅ The panel was successfully hidden for the user',
      'hiddenListEmpty' => '❌ No user exists in the hidden list',
      'hiddenPanelsCleared' => '✅ All hidden panels were removed',
      'hidePanelAllOnly' => '📌 This feature only applies when you have defined the product location as /all.',
      'inboundIdSaved' => '✅ The inbound ID was successfully saved',
      'inboundNameSaved' => 'The inbound name was successfully saved',
      'inboundUnsupported' => '❌ Defining an inbound is not supported for this panel',
      'invalidCredentials' => '❌ The panel username or password is incorrect',
      'invalidImage' => 'The image is invalid',
      'invalidSelection' => '❌ The selected panel is incorrect',
      'invalidToken' => '❌ The panel token is invalid',
      'invalidUrl' => '❌  The panel link sent is incorrect',
      'notConnected' => 'The panel is not connected',
...
2 - In the ip » services » http or https section, it must be enabled (if you have SSL, enable https, otherwise http)',
      'noteSendConfigUsername' => '❌ Note:
1 - From Panel Management > ⚙️ Set Protocol and Inbound, send a config username.',
      'noteSetAdminUuid' => '❌ Note:
1 - From Panel Management, set the following options

1 - admin uuid : get the admin UUID from the panel and register it
2-  Sub link domain :‌ send the Hiddify panel\'s sub link domain ',
      'noteSetGroupNameIbsng' => '❌ Note:
To activate, from Panel Management > Set Group Name, send a default group name you defined in ibsng to the bot.',
      'noteSetInboundAndDomain' => '❌ Note:
To activate the panel, go to the Panel Management menu and
you must set the inbound protocol and sub link domain options, otherwise no config will be created',
      'noteSetInboundId' => '❌ Note:
To activate the panel, go to the Panel Management menu,
go to the Set Inbound Protocol menu and set the config name, otherwise the bot will not create any config',
      'noteSetProtocolInbound' => '❌ Note:
To activate the panel, go to the Panel Management menu and
set the Protocol and Inbound options so the bot can issue configs, otherwise configs will not be given to users',
      'panelNotInList' => '❌ The panel is not in the list',
      'panelSelectedEndHide' => '✅ The panel was selected. When finished, send the /end_hide command for the final save.',
      'panelSelectedFinish' => '✅ The panel was selected. When finished, send the /finish command for the final save.',
      'panelSelectedRemove' => '✅ The panel was selected. When finished, send the /remove command for the final save.',
      'panelsHidden' => '✅ The panels were saved successfully and hidden for the user.',
      'panelsHiddenProduct' => '✅ The panels were saved successfully and hidden for the selected product.',
      'panelsShown' => '✅ The panels were shown successfully and enabled for the user.',
      'protocolSaved' => '✅ Your inbound and protocols were successfully set.',
      'qrBackgroundSaved' => '🖼 The background was successfully set',
      'selectPanel' => '🪚 To use this feature, select one of the panels below',
      'setupSaved' => '✅ The information was successfully set',
      'shown' => 'Is shown',
      'subLinkInactive' => 'The sub link is not active',
      'subLinkInvalid' => 'The sub link is invalid',
      'userGroupChanged' => '📌 The user group was successfully changed',
      ...
      'xuiErrorReason' => '❌ An error occurred, error reason:  ',
    ),
    'messageBulk' => 
    array (
...
User\'s username: %s
📝 Message text: %s',
      'answeredByOther' => '❌ The message was already answered by another admin.',
      'askAllowReply' => '📌 Should the user be able to reply or not?
1 - Yes, allow reply 
2 - No, don\'t allow reply
Send your answer as a number',
      'askButton' => '📌 If you want a button shown under the message, select an option from the list below; otherwise, press the Send without button button',
      'askInactiveDays' => '📌 With this feature, the message is sent to users who haven\'t used the bot for the number of days you set
Send your number of days.',
      'askPanelUsers' => '📌 To which users existing in the panels below should the message be sent.',
      ...
      'busy' => '❌ The message sending system is currently processing. Once it finishes and you\'re notified, you can send a new message.',
      'canceled' => '📌 The message sending was canceled.',
      'confirmStart' => 'By confirming the option above, the sending process will begin',
      'confirmSummary' => '📌 You are performing a message-sending operation. Review the information below and confirm the button to start the sending operation.
⚙️ Operation type : %s',
      'confirmSummary2' => '📌 You are performing a message-sending operation. Review the information below and confirm the button to start the sending operation.
⚙️ Operation type : %s
🎛 Service type : %s
🗂 User type : %s
%s
',
      'done' => '📌 The operation was completed for all requested users.',
      'errorRestart' => '❌ An error occurred, please redo the message sending steps from the beginning',
      'inactiveDaysLabel' => 'Number of days the user has been inactive : %s',
      'progress' => '✏️ The message sending operation is in progress...

Remaining number of people :  %s',
      'started' => '✅ The operation has started, you will be notified when it finishes.',
      'targetAllUsers' => 'Send to all users',
      'targetCustomers' => 'Customers',
      'targetInactiveUsers' => 'Users who haven\'t used it for the set number of days',
      'targetNoPurchase' => 'Those who haven\'t purchased',
      'textOnlyBroadcast' => '📌  In the broadcast section, only text can be sent.',
      'textOnlyInactive' => '📌  In the section for users who haven\'t used it for the set number of days, only text can be sent.',
    ),
    'month' => 
    array (
      1 => '⏳ One month',
    ...
    array (
      ...
      'askRejectReason' => '📌 The delete rejection request was successfully registered. Send the reason for rejection',
      'askTime' => '⌛️ Select your service duration ',
      'askVolume' => '📌 Send your requested volume.',
      'confirmDeleteFromDb' => '📌 By confirming the option below, this service will be completely deleted from the bot\'s database and will no longer be counted in statistics (this does not delete the service from the panel, only from the bot\'s database)',
...
📆 Purchase date : %s  
',
      'renewError' => '❌ Renewal encountered an error, please redo the renewal steps.',
      'renewErrorSupport' => '❌ An error occurred while renewing the service, please contact support',
      'requestRegistered' => '✅ Successfully registered',
      'selectService' => '⚠️ More than one service was found, select the correct one from the list below',
      'serviceReport' => '
📌 Service report 
🔗  Service type : %s
...
#️⃣ Connected client :<code>%s</code>',
      ...
      'typeChangeLocation' => 'Location change',
      'typeExtraTime' => 'Extra time',
      'typeExtraVolume' => 'Extra volume',
      'typeGiftTime' => 'Mass time gift',
      'typeGiftVolume' => 'Mass volume gift',
      'typeRenewNotInList' => 'Renewal type: user not in list',
...
<blockquote>🔹 | This bot is completely free and developed by the Mirza team</blockquote>

<blockquote>🔹 | Any sale or receiving of payment for this bot is considered a violation.</blockquote>

<blockquote>🔹 | If you notice a sale or payment being taken, please pursue and reclaim your money.</blockquote>

<blockquote>🐞 | If you encounter a bug or issue in the bot\'s operation, contact us via the **📬 Bot Report** button in the admin panel.</blockquote>',
      'backupCaption' => '📌 Main bot database export ',
      'botReportIntro' => '💬 | Bot Report

🔹 | If you encounter a <b>bug or issue</b> in the bot\'s operation, please let us know so we can review it.
➖➖➖➖➖➖➖➖➖➖➖
🔹 | If you encounter a <b>serious bug</b> or unusual behavior, report it quickly so it can be fixed.
➖➖➖➖➖➖➖➖➖➖➖
...
➖➖➖➖➖➖➖➖➖➖➖
🔹 | Also, if you need <b>guidance</b> or help, you can contact the support team directly.
...
<a href="https://t.me/mirzapanelgroup" rel="nofollow" target="_blank">Mirza Group</a>',
      ...
      'btnErrors' => '❌ Error report',
      'btnExport' => '🪪 Export data',
      'btnExportOrders' => '🪪 Export users\' orders',
      'btnExportPayments' => '🪪 Export users\' payments',
      'btnExportUsers' => '🪪 Export users\' data',
      ...
      'dailyBot' => '📌 Daily bot activity report :

🧲 Number of renewals today : %s pcs
💰 Total renewals today : %s Toman
🛍 Number of orders today : %s pcs
🛍 Total order amount today : %s Toman
🔑 Test accounts today : %s pcs
...
---------------
',
      'dailyTopAgentsTitle' => 'List of agents with the most purchases today :
',
      'gatewayRow' => '
📌 Gateway name : <code>%s</code>
 - Successful payment count : <code>%s</code>
 - Total payments : <code>%s</code>
',
      'lotteryTitle' => '📌 Dear admin, the following users won the lottery and their accounts were charged.
',
      'lotteryWinnerRow' => '
Username : @%s
Numeric ID : %s
...
✅ %s test orders were deleted.',
      'optimizeWarning' => '❌❌❌❌❌❌❌ Please read the text below carefully

📌 By confirming the option below, the following operations will be performed, and they cannot be undone
...
6 - Orders whose time or volume has run out
',
...
▫️Purchase time : %s',
      'accountCreatedAfterPay' => '📣 Account creation details after payment were registered in your bot .
...
▫️Final price : %s Toman
▫️Purchase time : %s',
      'accountCreatedMiniapp' => '📣 Account creation details in the mini app were registered .
...
▫️Product price : %s Toman
▫️Purchase time : %s',
      'agentExpiredGroupChanged' => '📌 The user\'s group was changed to f due to the agency time expiring

User numeric ID :  %s
Username :‌ %s',
      'balanceDecreased' => '📌 An admin has decreased a user\'s balance :
        
🪪 Deducting admin\'s information : 
Username :@%s
Numeric ID : %s
👤 User information  :
User numeric ID  : %s
Balance amount : %s
User\'s balance after deduction : %s',
      'balanceDecreased2' => '📌 An admin has decreased a user\'s balance :
...
🪪 Adding admin\'s information : 
Username :@%s
Numeric ID : %s
👤 Information of the user receiving the balance :
User numeric ID  : %s
Balance amount : %s
User\'s balance after the increase : %s',
      'balanceManualAdd' => 'Card-to-card receipt confirmed and balance manually increased by admin
...
▫️Config count : %s pcs
▫️Purchase time : %s',
      'checkReportGroup' => '❌ An error occurred while creating the subscription. To resolve the issue, check the error reason in your report group',
      'commissionPaid' => '
Amount %s was deposited to user %s as commission from user %s 
Time : %s',
      'commissionPaid2' => '
Amount %s was deposited to user %s as commission from user %s 
Time : %s',
...
Amount %s was deposited to user %s as commission from user %s 
Time : %s',
      'configCreatedByAdmin' => ' 🛍 Config created by admin 
...
Admin username : %s
Creation count : %s',
      'deleteRequestApproved' => '⭕️ An admin approved a user\'s service deletion request
        
Approving user information  : 

🪪 Numeric ID : <code>%s</code>
💰 Refund amount : %s Toman
👤 Username : %s
        Numeric ID of the cancellation requester : %s',
      'deleteRequestApproved2' => '⭕️ An admin approved a user\'s service deletion request
...
📌 A service deletion request has been sent to you by a user. Please review it and confirm if it\'s correct and you agree. 
...
<b>❌ Dear admin, please note that the delete service button calculates automatically and there is a chance of error; using manual deletion is recommended</b>

Reason for service deletion : %s',
      'discountCodeUsed' => '⭕️ A user with username @%s  and numeric ID %s used the discount code %s.',
      'discountCodeUsedFn' => '⭕️ A user with username @%s  and numeric ID %s used the discount code %s.',
      'discountUsed' => '⭕️ A user with username @{username}  and numeric ID {from_id} used the discount code {discount_code}.',
      'discountUsedRenew' => '⭕️ A user with username @{username}  and numeric ID {from_id} used the discount code {discount_code}. and renewed their service.',
      'disruption' => '
    ⚠️ A user has registered a service disruption report with the following information .
...
- Service location : %s
- Disruption description : %s',
      'errorAccountCreate' => '
⭕️ A user intended to receive an account but config creation encountered an error and no config was given to the user
✍️ Error reason : 
%s
User ID : %s
Username : @%s
Panel name : %s',
      'errorAqayePardakhtLink' => '⭕️ Error creating the Aghaye Pardakht link
✍️ Error reason : %s
...
Username : @%s
Panel name : %s',
      'errorChangeLocation' => 'Error while changing service location
Error reason : 
%s
User ID : %s
Username : @%s
...
Error creating config from admin panel
✍️ Error reason : 
%s
Admin ID : %s
Panel name : %s',
...
Panel name : %s',
      'errorCryptoLink' => '
                        ⭕️ A user intended to pay via the crypto gateway but creating the payment link encountered an error and the user was not given the link
✍️ Error reason : %s
...
Error reason : %s',
      'errorPaymentLink' => '
⭕️ A user intended to pay but creating the payment link encountered an error and the user was not given the link
✍️ Error reason : %s
...
Error reason : %s',
      'errorStarInvoice' => '
Error creating the Star invoice
✍️ Error reason : %s
...
Username : @%s
Panel name : %s',
      'errorSubscriptionCreateApi' => '❌ An error occurred while creating the subscription. To resolve the issue, check the error reason in your report group',
      'errorTestAccountCreate' => '
⭕️ A user intended to receive a test account but config creation encountered an error and no config was given to the user
✍️ Error reason : 
%s
User ID : %s
Username : @%s
Panel name : %s',
      'errorZarinpalLink' => '⭕️ Error creating the ZarinPal link
✍️ Error reason : %s
            
User ID : %s
Username : @%s',
      'extraTime' => '⭕️ A user has purchased extra time
...
💰 Amount paid : %s Toman
👤 Config username : %s',
      'extraTimeFn' => '⭕️ A user has purchased extra time
...
💰 Amount paid : %s Toman
👤 Config username %s',
      'extraVolume' => '⭕️ A user has purchased extra volume
...
',
      'extraVolumeFn' => '⭕️ A user has purchased extra volume
...
User numeric ID : %s
Transaction amount : %s 
Payment method : First Rial gateway',
...
💸 User\'s current balance : %s Toman
🛒 Payment tracking code: %s
⚜️ Username: @%s
💵 User\'s total payment count : %s pcs
💸 Amount paid: %s Toman
                
Description: %s %s
✍️ If the receipt is correct, please confirm the payment.',
      'newPaymentBalance2' => '
⭕️ A new payment has been made .
Balance increase            
👤 User account name : %s
...
Username : @%s
Numeric ID : %s',
      'paymentApproved' => '📣 An admin approved a payment receipt.
        
Information :
💸 Payment method : %s
👤Approving admin numeric ID : %s
💰 Payment amount : %s
👤 User numeric ID : <code>%s</code>
👤 Username : @%s 
        Payment tracking code : %s',
      'paymentRejected' => '❌ An admin rejected a payment receipt.
        
Information :
💸 Payment method : %s
👤Approving admin numeric ID : %s
Approving admin username : @%s
💰 Payment amount : %s
Rejection reason : %s
👤 User numeric ID: %s',
      'userBlocked' => 'The user with numeric ID
%s  was blocked in the bot 
Blocking admin : %s',
      'userUnblocked' => 'The user with numeric ID
%s  was unblocked in the bot 
Unblocking admin : %s',
      'renewedByAdmin' => '⭕️ An admin renewed the user\'s service.
...
🛍 Product name :  %s
👤 Customer username in panel  : %s
User\'s service location : %s',
      'userDeletedService' => 'Dear admin, a user has deleted their service after the volume or time ran out
Config username : %s',
      'newPaymentIranpay' => '💵 New payment
- 👤 Username : @%s
- ‏🆔User numeric ID : %s
- 💸 Transaction amount %s
- 💳 Payment method :  Third Rial gateway',
...
✍️ If the receipt is correct, please confirm the payment.',
      'paymentConfirmedExtraTime' => '✅ Payment confirmed
🔋 Extra time purchase
🛍 Purchased time  : %s days
👤 Config username %s
👤 User ID: <code>%s</code>
...
💸 Amount paid: %s Toman
',
      'paymentConfirmedExtraVolume' => '✅ Payment confirmed
🔋 Extra volume purchase
🛍 Purchased volume  : %s GB
👤 Config username %s
👤 User ID: <code>%s</code>
...
💸 Amount paid: %s Toman
',
      'paymentConfirmedService' => '✅ Payment confirmed
 🛍Service purchase 
 ▫️Config username :%s
▫️Service location : %s
👤 User ID: <code>%s</code>
...
',
      'paymentConfirmedRenew' => '✅ Payment confirmed
🔋 Service renewal
🪪 Config username : %s
🛍 Product name : %s
🌏 Location name : %s
...
Note change time : %s ',
      'supportMessage' => '
    📣 Dear support agent, a message from a user has been sent to you.
...
▫️User phone number : %s
▫️Purchase time : %s',
      'userBlockedByApi' => 'The user with numeric ID %s was blocked in the bot 
Performing admin : api site',
      'userUnblockedByApi' => 'The user with numeric ID %s was unblocked in the bot 
Performing admin : api site',
    ),
    'transfer' => 
    array (
...
<code>https://%s/app/</code>',
    ...
    'agentbot' => 
    array (
      'activatedUrl' => 'https://api.telegram.org/bot%s/sendmessage?chat_id=%s&text=✅ Dear user, your bot was successfully installed.',
      'activatedUrlAlt' => 'https://api.telegram.org/bot%s/sendmessage?chat_id=%s&text=✅ Dear user, your bot was successfully installed.',
      'alreadyInstalled' => '❌ This bot is already installed, reinstalling is not possible.',
      'askToken' => '📌 Send the token',
      'created' => '✅ The agent\'s bot was successfully created.
⚙️ Bot username  : @%s
🤠 Bot token : <code>%s</code>',
      'deleted' => '❌ The agent\'s sales bot was successfully deleted.',
      'intro' => '📌  In this section you can create a sales bot for your agent so the agent can sell using their own dedicated bot

- To create the bot, send the bot\'s token.',
      'invalidToken' => '❌ The token is invalid',
      'limitReached' => '❌  You are currently limited to creating 15 bots for your agents.',
      'noneFound' => '❌ No bot exists',
      'tokenExists' => '📌 This token is already registered',
      'webhookDone' => '✅ The webhook was successfully set.',
      'webhookRunning' => '📌 Setting up the webhook...',
    ),
    'api' => 
    array (
...
Current address: %s',
      'docsLink' => '📘 Full API documentation:
%s

Put the token above in the <code>Token</code> header of every request.',
      'token' => 'Your API token : <code>%s</code>',
    ),
    'apps' => 
    array (
      'added' => '✅ Your app link was successfully added.',
      'askLink' => '📌 Send the app download link',
      'askName' => '📌 To add the app download link, send the app name or button name.',
      'askNewLink' => '📌 Send the app\'s new link',
      'deleted' => '✅ The app was successfully deleted.',
      'nameTooLong' => '📌 The name must be less than 200 characters.',
      'selectDelete' => '📌 To delete the app, select the app name from the list below',
      'selectEdit' => '📌 To edit the app, select the app name from the list below',
      'updated' => '✅ The app link was successfully updated.',
    ),
    'askNewText' => '📌 Send your new text',
    'card' => 
    array (
      'afterFirstPayDesc' => '📌 By enabling this feature, the card-to-card gateway becomes active for the user after their first payment',
...
⚠️ Note that you can define multiple card numbers; if multiple card numbers are defined, one card number will be shown to the user at random',
...
%s',
      'deleted' => '✅ The card number was successfully deleted.',
      'disabled' => '✅  The card number was disabled',
      'enabled' => '✅  The card number was enabled',
      'enabledForUsers' => '✅ The card number was enabled for the sent users.',
      'enabledUserList' => '🪪 List of users for whom the card number is enabled',
      'exists' => '❌ The card number already exists in the database.',
      'mustBeNumeric' => '❌ The card number must be numeric.',
      'noUsersEnabled' => '📌 The card number is not enabled for any user',
      'saveFailed' => '❌ Saving the card number failed. Please try again or contact support.',
    ),
    'category' => 
    array (
      ...
      'askNewName' => '📌  Send the category\'s new name',
      'deleted' => '✅ The category was successfully deleted.',
      'notFoundAddFirst' => '❌ The selected category does not exist. Go to Plans > Add Category to add your category, then add the product.',
      'notFoundAddFirst2' => '❌ The selected category does not exist. Go to Plans > Add Category to add your category, then add the product.',
      'renamed' => '✅ The category name was successfully changed.',
      'selectDelete' => '📌 Select your category to delete',
      'selectEdit' => '📌 Select your category to edit',
    ),
    'changesSaved' => 'The changes were successfully applied',
    'changesSaved2' => '✅ The changes were successfully saved',
    'config' => 
    array (
      'askConfigs' => '📌 Send your configs like the example below.

# Config name ( only on one line, with # before the name ]
Config ( can be multiple lines 
...
trojan://xyz',
      ...
      'askNewContent' => 'Send the config\'s new content',
      'askProductName' => '📌 Send your product name. If you want to set it for the test account, send the word test.',
      'btnDelete' => '❌ Delete config',
      'deleted' => '✅ The config was successfully deleted.',
      'productNotFound' => 'No product was found with this name. Please send the exact product name, or send the word test to set up the test config.',
      'saveError' => '❌ An error occurred while saving the config. Please try again.',
      'saved' => '✅ Number of saved configs: ',
      'testKeyword' => 'test',
    ),
    'confirmByButton' => 'If you confirm, click the confirm button',
    'confirmByWord' => 'If you confirm, send the word below.
<code>Confirm</code>',
    'connection' => 
    array (
    ...
    'department' => 
    array (
      'added' => '📌 The department was successfully added.',
      'askDelete' => '📌 Send the department type to delete.',
      'askName' => '📌 Send the department name',
      'deleted' => '📌 The section was deleted.',
...
%s',
    ...
    'errorRestart' => '❌ An error occurred, please start the steps over from the beginning.',
    'gateway' => 
    array (
...
Your current merchant code : %s',
      'askAqayePardakhtMerchant' => '💳 Get your merchant code from Aghaye Pardakht and enter it in this section
        
Your current merchant code : %s',
      'askMerchant' => '💳 Get your merchant code and enter it in this section
        
Your current merchant code : %s',
      'askNowPaymentsApi' => '⚙️ Please send the NowPayments gateway API Key.

🔑 To get the API key, visit the site below:
nowpayments.io

📌 Your current key:
<code>%s</code>',
      'askPlisioApi' => '⚙️ Please send the Plisio gateway API Key.
...
📌 Your current key:
<code>%s</code>',
      'askTronWallet' => '💳 Send your TRC20 Tron wallet address
        
        Your current wallet : %s',
      'askZarinpalMerchant' => '💳 Get your merchant code from ZarinPal and enter it in this section
        
Your current merchant code : %s',
      'btnPerfectMoneyHelp' => '📚 Set Perfect Money tutorial',
      'intro' => '📌 From the list below you can manage the gateways.

⚠️ The Mirza team offers no guarantee for the gateways; use and all responsibility is on you',
      'off' => 'Turned off',
      'on' => 'Turned on',
      'tronadoDesc' => 'In this section you can turn the Tronado gateway on or off',
      'tronadoStatus' => 'Tronado gateway status',
    ),
    'gift' => 
    array (
      'askDays' => '📌 How many days do you want added to users\' services',
      'askMessage' => '📌 Send the text you want sent to the user',
      'askPanel' => '📌 For which panel\'s services do you want to gift volume or time?',
      'askUserCategory' => '📌 Which category of users should this apply to?',
      'askUserGroup' => '📌 Which user group should this apply to?',
      'askVolume' => '📌 How many GB of volume do you want added to the user\'s services',
      'busy' => '❌ The gift sending system is currently processing an operation. Once it finishes and you\'re notified, you can send a new message.',
      'canceled' => '📌 The gift sending was canceled.',
      'confirmStart' => '📌 Dear admin, by confirming the option below, the process of applying the gifts will begin. Note that due to the limits, applying the gifts will take some time.',
      'done' => '📌 The operation was completed for all requested services.',
      'panelNotFound' => '❌ The panel does not exist',
      'selectType' => '📌 Select one of the gifts below.',
      'started' => '✅ The gift sending operation started successfully. You will be notified once it\'s added and finished.',
      'volumeAddError' => 'Error adding the volume gift
Panel name : %s
Service username : %s
Error reason : %s',
      'volumeAddError2' => 'Error adding the volume gift
Panel name : %s
Service username : %s
Error reason : %s',
    ),
    'invalidValue' => '❌ Invalid value',
    'mainAdminOnly' => '❌ This section is only accessible to the main admin',
    'node' => 
    array (
      'askIp' => '📌 Send the node IP.',
      'askMultiplier' => '📌 Send your node\'s consumption multiplier.',
      'askName' => '📌 Send your node\'s name.',
      'askSetup' => '📌 To set up a node, create a user in your panel, activate the nodes you want enabled inside the panel, then send the user\'s username',
      'btnSettings' => '⚙️ Node settings',
      'deleted' => '✅ The node was successfully deleted',
...
🔺 Node API port : %s
🔋Total node consumption  : %s
🔄 Node consumption multiplier : %s
🔵 Node xray version : %s
🟢 Node status : %s
    ',
      'intro' => '📌 In this section you can manage the Marzban panel\'s nodes.',
      'ipSaved' => '✅  The node address was successfully saved.',
      'multiplierSaved' => '✅ The node consumption multiplier was successfully saved.',
      'nameSaved' => '✅  The node name was successfully saved.',
      'reconnected' => '✅ The node was reconnected.',
      'settingsUnavailable' => '❌  Viewing node settings is not available',
    ),
    'price' => 
    array (
      'allGroupsHint' => '⚠️ If you want the price to be set for all user groups, send the text <code>all</code>',
      'amountSaved' => '✅ The amount was successfully set',
      ...
      'askAgentVolume' => '📌 Set the minimum price you want the agent to pay per GB of volume',
      'askAmount' => '📌 Send the amount you want applied',
      'askBulkMin' => '📌 Send the minimum amount you want the user to have for bulk purchase.
...
Current amount : %s',
      ...
      'askDecreasePanel' => '📌 Which panel\'s products do you want to decrease the price of?
If you selected /all when defining the product, and want this category to have a price change, you must send /all',
      'askExtraTime' => '📌 Send the extra time price for this panel.',
      'askExtraVolume' => '📌 Send the extra volume price for this panel.',
      'askGroupN' => '📌 Send the price for group n.',
      'askGroupN2' => '📌 Send the price for group n2.',
      'askIncreasePanel' => '📌 Which panel\'s products do you want to increase the price of?
If you selected /all when defining the product, and want this category to have a price change, you must send /all',
      'askMaxTime' => '📌 Send the maximum custom time a user can get for this panel.',
      'askMaxVolume' => '📌 Send the maximum volume a user can get for this panel.',
      'askMinTime' => '📌 Send the minimum custom time a user can get for this panel.',
      'askMinVolume' => '📌 Send the minimum volume a user can get for this panel.',
      'askPaymentCashback' => '📌 In this section you can set what percentage is deposited as a gift into the user\'s account after payment. (Send 0 to disable this feature)',
      'askPaymentCashback2' => '📌 In this section you can set what percentage is deposited as a gift into the user\'s account after payment. (Send 0 to disable this feature)',
      'askPercent' => '📌 Send the percentage you want applied',
      'askPercentOrFixed' => '📌 Should the amount be added as a percentage or a fixed amount',
      'askPriceGroup' => '📌 Which user group should the price apply to 
f,n.n2',
      'askRenewCashback' => '📌 Send the percentage you want the user\'s account charged as a gift after renewal.
⚠️ Send 0 if you want this disabled',
      'askUserGroup' => '📌 Select the user type
f
n
n2',
      'changeLocationSaved' => '📌 The location change price was successfully changed',
      'customServiceIntro' => '📌 Before sending information, please read the text below. 
1 - This feature is for the custom service.
2 - If all your panels have the same price, instead of setting each price individually, you can use this feature to set all prices at once.
3 - Setting the price in this section cannot be undone.


To set the price, first send the price for group f.',
      'invalidUserGroup' => '❌ Invalid user group',
      'noProductFound' => '❌ No product was found to change the price of',
      'priceSaved' => '✅ The amount was successfully saved.',
      'rewardSaved' => '✅ The reward amount was successfully set',
      'saved' => '✅ The price was successfully saved.',
      'savedGroup' => '✅ The price was successfully set',
      'selectUserGroup' => '📌 Which user type should the price be set for?
User types : 
f = normal user
n = normal agent
...
🧾 <b>Total sales:</b> <code>%s</code> pcs  
🧾 <b>Total active service sales:</b> <code>%s</code> pcs  
💵 <b>Total sales amount:</b> <code>%s</code> Toman  
💵 <b>Total active service sales amount:</b> <code>%s</code> Toman  
🔄 <b>Total renewals:</b> <code>%s</code> Toman  
📈 <b>Customer conversion rate:</b> <code>%s</code>٪  
💳 <b>Average purchase per customer:</b> <code>%s</code> Toman  
📅 <b>Forecasted monthly revenue:</b> <code>%s</code> Toman  
📊 <b>Renewal percentage of sales:</b> <code>%s</code>٪  
...
🔹 <b>Type N agents:</b> <code>%s</code> people  
🔸 <b>Type N2 agents:</b> <code>%s</code> people  
🧩 <b>Number of panels:</b> <code>%s</code> pcs  
%s
',
      'lastHour' => '
🕐 <b>Statistics for the last 1 hour</b>


🛍 Number of orders : %s pcs
💸 Total order amount  : %s Toman

🧲 Number of renewals  : %s pcs
💰 Total renewal amount: %s Toman

📦 Extra volumes  :%s pcs
💰 Extra volumes amount : %s Toman

⏱️ Extra times  : %s pcs
💰 Extra times amount  : %s Toman

📍 Location changes  : %s pcs
💰 Location change amount : %s Toman
...
',
      'selectedRange' => '
🕐 <b>Statistics for the selected date</b>
...
💻 Total server RAM  : %s
💻 Marzban panel RAM usage  : %s
🌐 Total traffic used  (upload / download) : %s
🛍 Total sales count on this panel : %s
🛍 Total sales amount on this panel : %s Toman
User group :%s
...
└ IPv6: <code>{ipv6}</code>',
    ...
    'webpanel' => 
    array (
      'activated' => '✅  Your web panel was successfully activated.
...
⚠️ If you click the activate panel button again, you will receive a new password.',
      'miniAppHelp' => '📌 Tutorial for activating the Mini App in BotFather
...
<code>https://%s/app/</code>',
    ...
    'LangScope' => 
    array (
      'pickerCaption' => '🌐 Which language(s) should this be shown for?

Tap one of the options below.',
      'allLangsBtn' => '🌍 All languages',
      'savedConfirm' => '✅ Language saved successfully.',
      'langBtn' => '🌐 Language',
      'langBtnWithValue' => '🌐 Language: {val}',
      'hubBtn' => '🌐 Language-based Display Management',
      'hubCaption' => '🌐 <b>Language-based Display Management</b>

What would you like to set up?',
      'panelsBtn' => '🖥 Panels',
      'productsBtn' => '🛍 Products',
      'categoriesBtn' => '🗂 Categories',
      'panelsListCaption' => '🖥 <b>Panels</b>

Tap any panel to set its language.',
      'productsListCaption' => '🛍 <b>Products</b>

Tap any product to set its language.',
      'categoriesListCaption' => '🗂 <b>Categories</b>

Tap any category to set its language.',
      'backToHubBtn' => '🔙 Back',
      'emptyList' => 'Nothing to show yet',
      'cascadeBtn' => '⚡️ Bulk Language Set (Category+Products+Panels)',
      'cascadeIntro' => '⚡️ <b>Bulk Category Language Set</b>

Pick a category, then pick one or more languages. On apply, these all get set to the same language(s) together:
• the category itself
• all its products
• the panel(s) behind those products

⚠️ If a panel is shared across multiple categories, this will also affect those other categories — after applying, I\'ll show you which panels were shared.',
      'cascadePickerCaption' => 'Category: <b>%s</b>

🌐 Which language(s) should this category, its products, and its panels be shown for? You can pick more than one.

Then tap "Apply".',
      'cascadeApplyBtn' => '✅ Apply',
      'cascadeNeedOne' => '⚠️ Pick at least one language',
      'cascadeDone' => '✅ Category "%s" and its %d product(s) set to %s.',
      'cascadePanelsTouched' => '🖥 Panel(s) updated: %s',
      'cascadeSharedWarning' => '⚠️ Note: panel "%s" is also shared with these categories, whose language was affected too: %s',
      'gatewaysBtn' => '💳 Payment methods',
    ),
    'BtnStyle' => 
    array (
      'hubBtn' => '🎨 Customize Button Display',
      'hubCaption' => '🎨 <b>Customize Button Display</b>

What would you like to customize?

Current language: <b>{lang}</b>',
      'panelsSubCaption' => '🖥 <b>Panels</b>

Current language: <b>{lang}</b>',
      'productsSubCaption' => '🛍 <b>Products</b>

Current language: <b>{lang}</b>',
      'categoriesSubCaption' => '🗂 <b>Categories</b>

Current language: <b>{lang}</b>',
      'renameBtn' => '✏️ Custom Name',
      'renameCaption' => '✏️ <b>Custom Name</b>

Tap any item to change the name shown to users (the real database name stays the same).',
      'askRenameForItem' => '✏️ Send the new name to show for "%s"

(To restore the original name, send 0)',
      'renameSaved' => '✅ Custom name saved',
      'resetRenameBtn' => '🔄 Reset all custom names',
      'gatewaysSubCaption' => '💳 <b>Payment methods</b>

Current language: <b>{lang}</b>',
    ),
    'DisplayHub' => 
    array (
      'hubBtn' => '🎨 Shop Display & Appearance',
      'hubCaption' => '🎨 <b>Shop Display & Appearance</b>

Which section?',
    ),
    'MoveProd' => 
    array (
      'hubBtn' => '🔀 Move Products Between Categories',
      'hubCaption' => '🔀 <b>Bulk Move Products Between Categories</b>

First pick the source category.

💡 Moving a single product is always available from ✏️ Edit Product → Category too.',
      'pickDstCaption' => 'From "%s" (%d products) — which category should they move to?',
      'confirmCaption' => '⚠️ Are you sure? Move %d product(s) from "%s" to "%s"?',
      'confirmBtn' => '✅ Confirm & Move',
      'cancelBtn' => '❌ Cancel',
      'doneMsg' => '✅ %d product(s) moved from "%s" to "%s".',
      'needTwoCategories' => 'You need at least 2 categories to move products between.',
      'backToHubBtn' => '🔙 Back',
    ),
    'PanelMenu' => 
    array (
      'connectionBtn' => '🔧 Panel Details',
      'accountBtn' => '👤 Account Creation & Renewal',
      'pricingBtn' => '💰 Pricing',
      'testBtn' => '🎁 Test Account',
      'visibilityBtn' => '🫣 User Access',
      'otherBtn' => '📦 Other Settings',
      'backToPanelBtn' => '◀️ Back to Panel Menu',
      'submenuCaption' => '<b>%s</b>

Pick one of the options below.',
      'panelCaption' => '🖥 <b>%s</b>

This panel\'s settings are grouped into the categories below — tap any of them.',
    ),
    'BulkProduct' => 
    array (
      'btn' => '📦 Bulk Add Products',
      'intro' => '📦 <b>Bulk Add Products</b>

Send all products in <b>one message</b>, one product per line:

<code>name | price | volume | time</code>

Example:
<code>1 Month 30GB | 150000 | 30 | 30
2 Months 60GB | 280000 | 60 | 60
Unlimited 3 Months | 500000 | 0 | 90</code>

• Price in Toman
• Volume in GB — <b>0</b> means unlimited
• Time in days — <b>0</b> means unlimited
• Up to %d products at a time

Next I\'ll ask for the user tier, panel, category and note once for all of them.',
      'parseErrors' => '❌ <b>These lines have problems:</b>

%s

Fix them and send the <b>whole list</b> again.',
      'errFormat' => 'Line %d: must be exactly 4 parts separated by |',
      'errName' => 'Line %d: name is empty or longer than 150 characters',
      'errDup' => 'Line %d: a product named "%s" already exists',
      'errDupBatch' => 'Line %d: the name "%s" is repeated in this list',
      'errPrice' => 'Line %d: price must be a number',
      'errVolume' => 'Line %d: volume must be a number (0 = unlimited)',
      'errTime' => 'Line %d: time must be a number (0 = unlimited)',
      'errEmpty' => '❌ You didn\'t send any lines.',
      'tooMany' => '❌ Maximum %d products at a time. You sent %d lines.',
      'parsedOk' => '✅ <b>%d products read:</b>

%s',
      'askNote' => '🗒 Send a shared note for all of these products. It\'s shown on the user\'s invoice.

If you don\'t want a note, tap the button below.',
      'skipNoteBtn' => '⏭ No note',
      'confirmCaption' => '📦 <b>Final check</b>

👤 User tier: <b>{agent}</b>
🖥 Panel: <b>{panel}</b>{category}
🗒 Note: <b>{note}</b>{manual}

➖➖➖➖➖➖➖➖➖
🛍 <b>{count} products</b> will be created:

{list}',
      'confirmBtn' => '✅ Confirm & Save',
      'cancelBtn' => '❌ Cancel',
      'saved' => '🥳 <b>%d products saved successfully.</b>',
      'savedPartial' => '⚠️ %d products saved, %d were not (most likely duplicate names).',
      'cancelled' => 'Cancelled — no products were created.',
      'expired' => '❌ Couldn\'t find the data for this operation. Please start again.',
      'manualsaleNote' => '

⚠️ This is a manual-sale panel, so volume and time for all products will be set to <b>unlimited (0)</b>.',
      'noteNone' => 'No note',
      'categoryLine' => '
🗂 Category: <b>%s</b>',
...
… and %d more products',
    ...
    'ProdCurrency' => 
    array (
      'askLang' => '🌐 <b>Who should see this product?</b>

Each language has its own currency — you\'ll enter the price in that currency.',
      'allLangs' => '🌍 All languages',
      'invalidLang' => '❌ Tap one of the buttons below.',
      'askCurrency' => '💱 <b>Which currency should the price be in?</b>

The current one is marked ✅.',
      'invalidCurrency' => '❌ Pick one of the currencies below.',
      'askPrice' => '💰 <b>Subscription price</b>
...
⚠️ This differs from the default currency of <b>%s</b> — users whose wallet is in another currency won\'t be able to buy it.',
      'ruleWhole' => 'Whole numbers only (e.g. 50000).',
      'ruleDecimal' => 'Send a number — up to %d decimal places (e.g. 2.5).',
      'changeCurrencyBtn' => '💱 Change currency',
      'bulkIntroUnit' => '

💱 Prices are entered in <b>%s</b>.',
      'bulkAskLang' => '🌐 <b>Who should see these products?</b>

Each language has its own currency — you\'ll enter the prices in that currency.',
      'currencyBtn' => '💱 Product currency',
      'currencyUpdated' => '✅ Product currency updated',
      'askProductCurrency' => '💱 <b>This product\'s currency</b>

Current price: <b>%s</b>

⚠️ Changing the currency does not convert the number — only its unit. So %s becomes %s.',
    ),
    'GatewayLang' => 
    array (
      'hubBtn' => '💳 Payment gateways',
      'hubCaption' => '💳 <b>Payment gateways</b>

Pick a language first, then set up its gateways.
Tap a gateway\'s name for its own settings (a separate card number, for example).

✅ / ❌ — on or off for this language

Current language: <b>{lang}</b> · Currency: <b>{currency}</b>',
      'allGateways' => 'all',
      'countLabel' => '%d of %d',
      'enableAll' => '✅ Enable all',
      'disableAll' => '❌ Disable all',
      'noneWarn' => '⚠️ No gateway is enabled for this language — its users can\'t top up.',
      'globallyOff' => ' ⚫️',
      'backBtn' => '🔙 Back',
      'saved' => '✅ Saved',
      'autoOn' => 'on',
      'autoOff' => 'off',
      'adminNoGatewayAlert' => '⚠️ <b>Payment gateway warning</b>

A user with language <b>%s</b> tried to pay but <b>no gateway</b> was enabled for them.

Check it under 💎 Financial → 💳 Payment gateways.',
      'setCaption' => '<b>{gateway}</b> — {lang}

Values without 🌐 apply only to <b>{lang}</b> users; a colored button means this language has its own value, a plain one means it\'s inherited from the global 💎 Financial settings.

Currency for this language: {currency}',
      'onForLang' => '✅ On for this language',
      'offForLang' => '❌ Off for this language',
      'cardsLabel' => '💳 Card numbers',
      'walletLabel' => '💼 Wallet address',
      'inheritedAs' => 'default (%s)',
      'notSet' => 'not set',
      'resetBtn' => '🗑 Clear this language\'s customizations',
      'resetDone' => '🗑 This language\'s customizations were cleared',
      'askValue' => '✏️ Send the new <b>{field}</b> for <b>{lang}</b>.

Current global value: <code>{global}</code>

Send <b>0</b> to go back to the global value.',
      'invalidMoney' => '⛔️ That amount is not valid. Send a number only (e.g. 50000 or 2.5).',
      'globallyOffWarn' => '⚠️ This gateway is switched off globally in 💎 Financial, so nobody sees it right now.',
      'cardsCaption' => '💳 <b>Card numbers for {lang}</b>',
      'cardsOwnHint' => 'This language has its own dedicated cards.',
      'cardsGlobalHint' => 'Currently using the bot\'s shared cards (🔒). This stays true until you add a card of your own.',
      'cardsNoneWarn' => '⚠️ There are no cards — users of this language cannot top up by card transfer.',
      'cardAddBtn' => '➕ Add a card',
      'cardAskNumber' => '💳 Send the card number.',
      'cardAskName' => '👤 Send the cardholder\'s name.',
      'cardInvalid' => '⛔️ That card number is not valid.',
      'globalToggleBtn' => '🌐 Global status (all languages): %s',
      'legacyBtn' => '🔑 Technical settings (shared by every language)',
      'colTitle' => 'Title',
      'colStatus' => 'Status',
      'colAction' => 'Action',
      'cartDirectLabel' => '👤 Support ID (direct payment)',
      'apiKeyLabel' => '🔑 API key',
      'merchantLabel' => '🔑 Merchant ID',
      'payUrlLabel' => '🔗 Gateway URL',
      'cashbackLabel' => '🎁 Cashback percentage',
      'globalFieldPrefix' => '🌐 ',
      'globalFieldHint' => '🌐 means this value is shared by every language (one processor account for the whole bot).',
      'askValueGlobal' => '✏️ Send the new value for <b>{field}</b>.

🌐 This value is used for <b>all languages</b>.

Current value: <code>{current}</code>',
      'cardEditModeBtn' => '✏️ Edit card number',
      'cardDeleteModeBtn' => '🗑 Delete card numbers',
      'cardDeleteConfirmBtn' => '🗑 Delete selected',
      'cardCancelBtn' => '❌ Cancel',
      'cardsDeleteModeCaption' => '💳 <b>{lang} card numbers</b>

Select the cards you want to delete, then tap "Delete selected".',
      'cardsEditModeCaption' => '💳 <b>{lang} card numbers</b>

Which card do you want to edit?',
      'cardEditAskNumber' => '💳 Send the new card number.

Current number: <code>{current}</code>',
      'cardEditAskName' => '👤 Send the new cardholder name.

Current name: <code>{current}</code>',
      'cardNoneSelectedAlert' => '⚠️ No card selected.',
      'cardsDeletedToast' => '🗑 %d card(s) deleted.',
    ),
    'shopSettingsCaption' => '🏬 <b>Shop settings</b>

Everything to do with <b>selling</b> lives here:

🗂 <b>Catalog</b> — the categories and products your users see
🎨 <b>Appearance</b> — who sees what, and how the buttons look
🎁 <b>Discounts</b> — gift codes and discount codes

What would you like to set up?',
    'TopupPkg' => 
    array (
      'hubCaption' => '🏦 <b>Top-up packages</b>

For each gateway, define a few suggested amounts so users can pick one instead of typing a number (a "custom amount" option is always offered too).

Current language: <b>{lang}</b> · Currency: <b>{currency}</b>',
      'addBtn' => '➕ Add a package',
      'backBtn' => '🔙 Back',
      'askAmount' => '#️⃣ <b>Send the package amount</b>

Send the amount in <b>{currency}</b>.

You can add a short label after a space:
• <b>With label:</b> <code>50000 recommended</code>
• <b>Without label:</b> <code>50000</code>',
      'invalidAmount' => '⛔️ That amount is not valid. Send it again.',
      'editCaptionBtn' => '✏️ Edit caption',
      'displayBtn' => '🎨 Display appearance',
      'minmaxBtn' => '#️⃣ Custom-amount min/max',
      'pickCaption' => '💰 <b>{label}</b>\\n\\nWhat do you want to do?',
      'editBtn' => '✏️ Edit',
      'deleteBtn' => '🗑 Delete',
      'askAmountEdit' => '✏️ Send the new amount and label (same as when adding).

Current: <b>{amount}</b> — {label}

Currency: <b>{currency}</b>',
      'noLabel' => 'no label',
      'askCaption' => '✏️ <b>Send the new caption text</b>

Whatever you send is exactly what the user will see; you can also use HTML for extra styling.
💎 If the text starts with a premium emoji, it stays right at the start of the caption.

<b>📌 Formatting guide</b>
Replace <code>X</code> with your own text:

<b>🔹 Text style</b>
• <b>Bold:</b> <code>&lt;b&gt;X&lt;/b&gt;</code>
• <b>Italic:</b> <code>&lt;i&gt;X&lt;/i&gt;</code>
• <b>Underline:</b> <code>&lt;u&gt;X&lt;/u&gt;</code>
• <b>Strikethrough:</b> <code>&lt;s&gt;X&lt;/s&gt;</code>

<b>🔹 Special blocks</b>
• <b>Mono:</b> <code>&lt;code&gt;X&lt;/code&gt;</code>
• <b>Copyable:</b> <code>&lt;pre&gt;X&lt;/pre&gt;</code>
• <b>Quote:</b> <code>&lt;blockquote&gt;X&lt;/blockquote&gt;</code>

<b>🔹 Link</b>
• <b>Link:</b> <code>&lt;a href="URL"&gt;X&lt;/a&gt;</code>',
      'displayPickCaption' => '🎨 <b>Package appearance</b>

Tap a button to customize it.',
      'displayPickedCaption' => '🎨 <b>{label}</b>\\n\\nWhat should we change?',
      'renameBtn' => '✏️ Edit name',
      'emojiBtn' => '🎭 Emoji',
      'askName' => '✏️ Send this package\'s new label.

To go back to showing just the amount, send 0.',
      'askEmoji' => '🎭 Send an emoji (regular or premium) to show next to this button.

To remove the emoji, just send 0.',
      'minmaxCaption' => '#️⃣ <b>Min/max custom amount</b>

This only limits the "custom amount" option for this gateway/language; preset amounts are always selectable.

⬇️ Min: <b>{min}</b>
⬆️ Max: <b>{max}</b>',
      'noLimit' => 'no limit',
      'setMinBtn' => '⬇️ Set minimum',
      'setMaxBtn' => '⬆️ Set maximum',
      'askMin' => '⬇️ Send the minimum amount in <b>{currency}</b>.

To remove the limit, send 0.',
      'askMax' => '⬆️ Send the maximum amount in <b>{currency}</b>.

To remove the limit, send 0.',
      'colorCycleBtn' => '🎨 Change color',
      'invalidEmoji' => '⚠️ Please send an emoji (regular or premium) 😅',
      'resizeBtn' => '🔀 Reorder',
      'sizeCaption' => '📐 <b>Button layout</b>

Buttons per row: {n}',
      'colDecBtn' => '➖ Decrease',
      'colIncBtn' => '➕ Increase',
      'swapStartBtn' => '🔄 Reorder',
      'doneSwapBtn' => '✅ Done reordering',
      'swapPickFirstCaption' => '🔄 Pick the first button.',
      'swapPickSecondCaption' => '🔄 Now pick the second button to swap them.',
      'deleteAllBtn' => '🗑 Delete all',
      'deleteAllConfirmCaption' => '⚠️ Are you sure you want to delete ALL packages for this gateway/language? This cannot be undone.',
      'deleteAllConfirmBtn' => '✅ Yes, delete all',
      'deleteAllCancelBtn' => '❌ Cancel',
      'defaultCaptionBtn' => '📋 Default caption',
      'closeCaptionPromptBtn' => '❌ Close',
      'closeAmountPromptBtn' => '❌ Close',
      'closePromptBtn' => '❌ Close',
    ),
  ),
  'textbot' => 
  array (
...
Dear customer, deposit <b>{price} Toman</b> to the account below:

<code>{card_number}</code>
<code>{name_card}</code>

<b>After depositing, send the receipt image right here.</b>

This card number is valid for only <b>30</b> minutes, just for this invoice; the receipt is usually reviewed within about 5 minutes.',
...
- Service username :‌ {service_username}',
    ...
    'mirzaAgentPanel' => 'Mirza agency',
    'setGroupName' => '🎛 Set group name',
    'subLinkDomain' => '🔗 Sub link domain',
    'panelTypeSanaei' => '3x-ui',
    'panelTypeAlireza' => 'Alireza single port',
    'usernameMethodAgentCustom' => 'Agent custom text + sequential number',
...
- 💳 Payment method :  nowpayment',
  ...
  array (
    ...
    array (
      ...
      'rial1' => 'Rial payment gateway',
      'rial2' => 'Second Rial payment gateway',
    ),
    'labels' => 
    array (
      'testServiceName' => 'Test service',
      ...
      'confirmedByAdminAlt' => '✅ Confirmed by admin',
      'firstPurchaseAlt' => '📌 User first purchase',
      'autoConfirmedByBot' => 'Approved by the bot without review',
      'confirmedByAdmin' => '✅ Confirmed by admin',
      'customService' => '⚙️ Custom service',
      'customUsername' => 'Custom username',
      'customUsernameRandom' => 'Custom username + random number',
      'firstPurchase' => '📌 User first purchase',
      'receiptNotSent' => '🔴 Not sent 🔴',
      'test' => 'Test',
