...
当前语言：<b>{lang}</b>',
                ...
                'msg_saved' => '✅ 文本已保存。',
                'groupVerifyLabel' => "📞 手机验证与规则消息",
                'groupWheelLabel' => "🎲 幸运转盘消息",
                'groupReferralLabel' => "🎁 推荐消息与按钮",
                'groupVerifyCaption' => "📞 <b>手机验证与规则</b>\n\n您想设置哪一项？\n\n📌 每种语言允许的国家代码在「🌐 功能状态（各语言）」中设置，不在此处。此页面仅包含文本和按钮。\n\n当前语言：<b>{lang}</b>",
                'groupWheelCaption' => "🎲 <b>幸运转盘消息</b>\n\n您想设置哪一项？\n\n📌 奖金金额在「🌐 功能状态（各语言）」→ ⚙️ 转盘设置中设置。\n\n当前语言：<b>{lang}</b>",
                'groupReferralCaption' => "🎁 <b>推荐消息与按钮</b>\n\n您想设置哪一项？\n\n📌 佣金、礼金金额和横幅在「🌐 功能状态（各语言）」→ ⚙️ 推荐设置中设置。\n\n当前语言：<b>{lang}</b>",
                'msg_closed' => '已关闭。',
                'langs' => [
                        'fa' => '🇮🇷 فارسی',
                        'en' => '🇬🇧 English',
...
✍️ 或复制您的银行短信内容发送到这里',
                        ...
                        'receiptNeedsPhotoOrText' => '❌ 请发送收据图片，或发送您的银行短信内容（其中需包含金额）。',
                        'textReceiptFromUser' => '🧾 <b>用户的文字收据：</b>',
...
客服账户：@%s',
                ...
                'number' => [
                        ...
                        'erroriran' => "❌ 您发送的号码不被允许。\n\n仅接受国家代码为 {prefixes} 的号码。",
...
',
                ...
                'FeatureSection' => [
                        'back' => '🔙 返回',
                        'cancel' => '❌ 取消',
                        'appTitle' => "🔗 <b>应用下载链接</b> — {lang}\n\n此列表仅属于该语言。{list}\n\n✏️ 修改链接，🗑 删除。🌍 表示该条目对所有语言可见。",
                        'appNone' => "\n— 尚未添加应用 —",
                        'appAdd' => '➕ 添加应用',
                        'wheelTitle' => "🎲 <b>幸运转盘设置</b> — {lang}\n\n奖金：<b>{price}</b>\n\n此金额仅适用于该语言。",
                        'wheelPriceBtn' => '💰 奖金：{price}',
                        'affTitle' => "🎁 <b>下线推荐设置</b> — {lang}\n\n佣金：<b>{percent}%</b>\n加入礼金：<b>{gift}</b>\n\n这些设置仅适用于该语言。",
                        'affPercentBtn' => '📊 佣金：{percent}%',
                        'affGiftBtn' => '🎁 加入礼金：{gift}',
                        'affBannerBtn' => '🖼 推荐横幅',
                        'affCommissionBtn' => '💵 购买佣金',
                        'affStartGiftBtn' => '🎉 加入礼金',
                        'affFirstBuyBtn' => '1️⃣ 仅首次购买',
                        'locTitle' => "🌍 <b>位置更改限制</b> — {lang}\n\n总限制：<b>{all}</b>\n免费更改：<b>{free}</b>\n\n这些数值仅适用于该语言。",
                        'locAllBtn' => '🔢 总限制：{all}',
                        'locFreeBtn' => '🆓 免费更改：{free}',
                        ...
                        'phoneTitle' => "📞 <b>手机号验证</b> — {lang}\n\n允许的国家代码：<b>{prefixes}</b>\n\n该语言开启手机验证时，仅接受以此开头的号码。未设置代码时，接受任何国家。",
                        'phonePrefixBtn' => "🌍 国家代码：{prefixes}",
                        'phoneAny' => "所有国家",
                        'ask_phone_prefix' => "🌍 请发送 <b>{lang}</b> 允许的国家代码（不含 +）。\n\n示例：<code>86</code>\n多个：<code>86,852</code>\n取消限制：<code>0</code>",
                ],
                'Status' => [
                        'Authenticationiran' => "📞 要求手机号国家代码",
                        'Authenticationphone' => '☎️ 电话号码身份验证',
                        'activePanel' => '⭕️ 在此部分，您可以开启或关闭面板的销售功能',
                        'activePanelOff' => '❌ 面板已关闭',
                        'activePanelOn' => '✅ 面板已开启',
                        'autoConfirmCard' => '卡转卡收据自动确认状态',
                        'botTitle' => "⚙️ <b>功能状态</b>\n\n每个按钮可开启或关闭一项功能 - 点击即可切换状态。\n\n✅ 开启   |   ❌ 关闭\n\n这些设置是全局的：对机器人的所有语言都相同。\n\nℹ️ 需要按语言分别设置的项目（手机验证、幸运转盘、代理申请等），请使用「🌐 功能状态（各语言）」按钮。",
                        'shopBotTitle' => "📌 <b>商店功能状态</b>\n\n每个按钮可开启或关闭一项功能 - 点击即可切换状态。\n\n✅ 开启   |   ❌ 关闭\n\n🌐 这些设置按语言分别保存 - 请先在上方选择语言，然后为该语言开启/关闭。对某一种语言所做的更改不会影响其他语言。\n\n当前语言：<b>{lang}</b>",
                        'featureLangBotTitle' => "🌐 <b>功能状态（各语言）</b>\n\n每个按钮可为所选语言开启或关闭一项功能。\n\n✅ 开启   |   ❌ 关闭\n\n🌐 这些设置按语言分别保存 - 请先在上方选择语言，然后为该语言开启/关闭。对某一种语言所做的更改不会影响其他语言。\n\nℹ️ 全局设置（整个机器人的开关、定时任务等）请使用「⚙️ 功能状态」按钮。\n\n当前语言：<b>{lang}</b>",
                        'btn' => '📊 机器人统计',
